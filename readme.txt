Random String Generator for Java
...
******************************************************************
This is a Java library for generating random strings with fully
customizable settings to set the number of upper, lower, numeric,
and special characters along with the length of the string.
This library can be used for various application such as random 
password generation.
